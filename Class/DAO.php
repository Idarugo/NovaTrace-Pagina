...
class DAO {
  ...
  private function conexion(){
    $this->mi = new mysqli("us-cdbr-east-06.cleardb.net","bd2afeddb63b20","df20e8da","heroku_a50bea369876c7e");

    if ($this->mi->connect_errno) {
      die("Error al establecer la conexion a la BD -> heroku_a50bea369876c7e");
    }
  }
